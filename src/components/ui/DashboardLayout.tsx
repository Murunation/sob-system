...
export default function DashboardLayout({ children, navItems, role }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[#1E1B4B] min-h-screen flex flex-col fixed left-0 top-0 z-40">
        {/* Logo */}
        ...
        <div className="px-4 py-4 border-t border-white/10">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-white/50 hover:text-white/80 hover:bg-white/8 text-xs transition"
          >
